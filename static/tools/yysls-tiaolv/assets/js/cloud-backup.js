(function() {
    ...
    function renderHistory() {
        ...
        if (elements.historyToggle) {
            elements.historyToggle.textContent = state.historyExpanded ? "收起" : "展开";
            elements.historyToggle.setAttribute("aria-expanded", state.historyExpanded ? "true" : "false");
        }
        elements.history.classList.toggle("hidden", !state.historyExpanded);
    ...
    function injectUi() {
        ...
        elements.historyToggle = document.getElementById("cloud-history-toggle");
