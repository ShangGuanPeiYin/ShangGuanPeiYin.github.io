(function () {
    ...
    function injectZhuanlvStyles() {
        ...
        style.textContent = [
            ...
            '}',
            '.zhuanlv-slot-radio:checked::before {',
            '  content:"✓";',
            ...
            '  display:grid;grid-template-columns:repeat(3,minmax(190px,220px));gap:8px;justify-content:start;',
            '}',
            '@media (max-width:1100px) {',
            '  #zhuanlv-target-checkboxes { grid-template-columns:repeat(2,minmax(190px,260px)); }',
            '}',
